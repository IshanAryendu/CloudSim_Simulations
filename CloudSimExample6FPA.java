 ...
 */
public class CloudSimExample6FPA {
...
//		Random robj = new Random();
	...
	public static void main(String[] args) {
		Log.printLine("Starting CloudSimExample FPA...");
		...
		try {
			...
			int arr[] = FlowerPollinAlgo.init(burstTime, cloudlets, vms);
			for(int i=0;i<cloudlets;i++){
			broker.bindCloudletToVm(cloudletList.get(i).getCloudletId(), arr[i]);
			}
